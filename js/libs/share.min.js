!function() {
    $.fn.share = function(opts) {
        ...
        return $(this).each(function(i, el) {
            ...
            $(this).html("<label class='zocial-" + config.button_icon + "'><span>" + config.button_text + "</span></label><div class='social " + config.flyout + "'><ul><li class='zocial-twitter' data-network='twitter'></li><li class='zocial-facebook' data-network='facebook'></li><li class='zocial-gplus' data-network='gplus'></li></ul></div>");
